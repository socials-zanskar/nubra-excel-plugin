...
$outFile = Join-Path $desktop 'EMA_9_60_Rulebook_Backtest_v3.xlsx'
...
try {
  ...
  $ws.Range('J3').Formula = '=IF(B3="","",IF(LEFT(I2,9)="EXIT_LONG","EXIT_LONG",IF(LEFT(I2,10)="EXIT_SHORT","EXIT_SHORT",IF(H2="BUY_SIG","BUY",IF(H2="SELL_SIG","SELL","")))))'
  ...
  # PnL and costs
  $ws.Range('O3').Formula = '=IF(B3="","",IF(J3="EXIT_LONG",C3-L2,IF(J3="EXIT_SHORT",L2-C3,0)))'
  $ws.Range('P3').Formula = '=IF(B3="","",IF(OR(J3="BUY",J3="SELL",J3="EXIT_LONG",J3="EXIT_SHORT"),C3*$X$5,0))'
  $ws.Range('Q3').Formula = '=IF(B3="","",IF(OR(J3="BUY",J3="SELL"),-P3,IF(OR(J3="EXIT_LONG",J3="EXIT_SHORT"),O3-P3,0)))'
